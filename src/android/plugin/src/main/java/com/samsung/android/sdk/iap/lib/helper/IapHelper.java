...
public class IapHelper extends HelperDefine {
    ...
    private final ArrayList<BaseService> mServiceQueue = new ArrayList<BaseService>();
    ...
    (
        ...
        try {
            ...
            if (_passThroughParam != null && _passThroughParam.getBytes(StandardCharsets.UTF_8).length > HelperDefine.PASSTHROGUH_MAX_LENGTH) {
            ...
            if (_passThroughParam != null) {
                encodedPassThroughParam = Base64.encodeToString(_passThroughParam.getBytes(StandardCharsets.UTF_8), 0);
            }
